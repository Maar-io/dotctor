  ...
  return (
    <>
      <Form>
        ...
        <Form.Group as={Row} className="ml-1 justify-content-md-center">
          <Form.Check className="mr-3"
            type="switch"
            id="large"
            label="large "
            onChange={largeEnabled}
          />
          <Form.Check
            type="switch"
            id="sort"
            label="Sort by commit"
            onChange={sortCommit}
          />
        </Form.Group>
      </Form>
      ...
      <Query network={network} utility={utility} large={large} sort={sort}/>
    </>
  )
}
